...
namespace ConstructionLine.CodingChallenge.Tests
{
    public class SearchEngineTestsBase
    {
                ...
                var expectedSizeCount = shirts
                    .Count(s => s.Size.Id == size.Id
                                ...
                                && (!searchOptions.Sizes.Any() ||
                                    searchOptions.Sizes.Select(si => si.Id).Contains(s.Size.Id)));
        ...
        protected static void AssertColorCounts(List<Shirt> shirts, SearchOptions searchOptions,
            ...
            foreach (var color in Color.All)
            {
                ...
                var expectedColorCount = shirts
                    .Count(c => c.Color.Id == color.Id
                                ...
                                && (!searchOptions.Colors.Any() ||
                                    searchOptions.Colors.Select(col => col.Id).Contains(c.Color.Id)));
